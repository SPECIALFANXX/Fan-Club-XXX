...
<div id="payment" class="page">
    ...
    <form id="paymentForm">
        ...
        <label>
            <input type="radio" name="paymentMethod" value="Venmo" required> Venmo
        </label><br>
...
<div id="paymentConfirmation" class="page">
    ...
    <p>Please forward all payment screenshots to the following email address: specialfanpagexx@gmail.com</p>
...
<script>
    ...
    paymentForm.addEventListener('submit', function(event) {
        ...
        switch (selectedPaymentMethod) {
            case 'CashApp':
                paymentInfo = 'Cash App: $SoutherFusion';
                break;
            case 'PayPal':
                paymentInfo = 'PayPal: M.howe30@yahoo.com';
                break;
            case 'Crypto':
                paymentInfo = 'Crypto: 13CVQWXmyHA1YgcH9JDUq7BWkZGfcdKEoN';
                break;
            case 'Venmo':
                paymentInfo = 'Venmo: @Matthew-Howe-238';
                break;
        }
